...
def paint():
    ...
    paintwindows = tk.Frame(root, bg="black", height=400, width=500, borderwidth=2, relief="ridge")
    ...
    color_btn = tk.Button(paintwindows, width=5, text=colors[current_color_index], bg="tan", fg="black",
                          activebackground="burlywood", activeforeground="white", command=toggle_color)
    ...
    clear_btn = tk.Button(paintwindows, text="Clear", command=clear_canvas, bg="red", fg="black",
                          activebackground="pink", activeforeground="white")
    clear_btn.place(x=10, y=0)

    fill_btn = tk.Button(paintwindows, text="Fill", command=fill, bg="tan", fg="black",
                         activebackground="burlywood", activeforeground="white")
    fill_btn.place(x=105, y=0)

    cancel_btn = tk.Button(paintwindows, text="x", command=paintwindows.destroy, fg="red", height=1, font=("Arial", 10))
...
def show_os():
    ...
    paintapp = tk.Button(root, text="Paint.exe", command=paint)
    paintapp.place(x=28, y=206,)
